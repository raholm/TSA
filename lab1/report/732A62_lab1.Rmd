...
In the first plot there seems a monthly variation over all years with a linear decreasing trend with what could be considerd a constant variance. It could be debated that it might be a lower variance in the end series.
