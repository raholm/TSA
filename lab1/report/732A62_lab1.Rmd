...
In the theoretical ACF it seems to indicate that the correlation should be dying down in a positive to negative correlations between the lags. This would indicate that the ARMA we fitted is apart from what is expected from the theoretical and therefore not apropriate for the data.
...
The AFC comfirms what has been seen in the previous plots, a strong seasonal pattern presents it self in the correlations between the lags. 
...
Judging from the AFC we come to a similar conclusion where most of the correlation between lags have dissapeard, some correlation seem to remain in the second lag.
