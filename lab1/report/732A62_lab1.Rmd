...
The log-transformation put the two time series in similar scales which makes it easier to compare them in detail. The fluctuations are clearly similar in both time series.
...
In the plot above we see the two time series after computing the first difference and we can see a resemblance of the two with a few different peaks, but otherwise quite similar.
...
The residuals do look stationary with a few outlying peaks.
