...
After having performed difference of order 1 we can clearly see that there is a seasonal trend in the data. The ACF suggests a seasonality of 10 that tails off for a while then goes up again. This may indicate an AR model.

### Difference 1 Data PACF
The PACF shows that the seasonality cuts off after lag 10 which is 1 * 10 indicating an AR(1) model.

### Final Verdict
Needs further investigation
ARIMA(1, 0, 0) x $(1, 1, 0)_10$
