...
fit_plot <- function(model) {
    ...
    plot(c(model$x, pred$pred), type="l",
         xlim=c(500, length(oil) + 20),
         ylim=c(min(lower_band), max(upper_band)))
...
sapply(polyroot(c(1)), complex_dist)
...
The figure above displays 20 steps ahead prediction. The intervals looks resonable and the prediction aswell.
